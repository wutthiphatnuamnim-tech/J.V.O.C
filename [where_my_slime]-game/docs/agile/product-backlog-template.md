...
| 3 | As a player, I want to Stand , so that I Need Background stage to make me stand        | มี Background แสดงขึ้นมา เพื่อไม่ให้แสดงว่าตัวละครยืนลอย | 6             | 2      |
| 4 | As a player, I want to see UI, so that I can interact in game                          | สามารถกดเพื่อแสดง action                                                           | 7             | 2      |
| 5 | As a player, I want to see my Ultimate skill, so that To make me feel impact           | สามารถใช้สกิล ulitimate ได้                                                         | 15            | 2      |
| 6 | As a player, I want to hear SFX, so that To make me feel impressive                    | สามารถได้ยินเสียง SFX ได้                                                       | 3             | 3      |
| 7 | As a player, I want to watch cutscenes Story, so that I can understand the story     | สามารถเห็นฉาก cutscene เพื่อแสดงเนื้อเรื่องได้                  | 15            | 1      |
